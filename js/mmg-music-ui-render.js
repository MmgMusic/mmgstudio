...
function createGridViewCard(item, type, profile) {
    ...
    return `
        <div class="card ${isLocked ? 'locked' : ''}" data-item-id="${item.id}" data-item-type="${type}" tabindex="0" role="button">
            <div class="card-image-container">
                <img src="${getCorrectImagePath(item, 'thumb')}" alt="${title}" loading="lazy" width="300" height="300">
...
function createListViewCard(item, type, profile) {
    ...
    return `
        <div class="card list-view-card ${isLocked ? 'locked' : ''}" data-item-id="${item.id}" data-item-type="${type}" tabindex="0" role="button">
            <div class="list-view-img">
                <img src="${getCorrectImagePath(item, 'thumb')}" alt="${title}" loading="lazy" width="60" height="60">
...
function renderHeroAccordion() {
    ...
    const upcomingImage = upcomingData ? upcomingData.image : "assets/backgrounds/icons.svg";
        ...
        <div class="news-article-view">
            <header class="news-article-header">
                <div class="news-article-header-image">
                    <img src="${news.image}" alt="${news.title}" class="news-article-img-header" width="800" height="450">
                </div>
    ...
    container.innerHTML = `
        <div class="upcoming-release-view">
            <div class="upcoming-release-cover">
                <img src="${upcomingData.image}" alt="${upcomingData.title}" width="300" height="300">
            </div>
        ...
        <div class="playlist-item-wrapper">
            <div class="playlist-item-content">
                <div class="playlist-item currently-playing" data-item-id="${currentPlayingItem.id}">
                    ...
                    <img src="${getCorrectImagePath(currentPlayingItem, 'thumb')}" alt="${currentPlayingItem.title}" width="48" height="48">
            ...
            <div class="playlist-item-wrapper">
                ...
                <div class="playlist-item-content">
                    <div class="playlist-item" data-item-id="${itemId}">
                        ...
                        <img src="${getCorrectImagePath(item, 'thumb')}" alt="${item.title}" width="48" height="48">
                        <div class="playlist-item-info">
...
function handleRecoPlaylistClick(e) {
    ...
    if (saveBtn) {
        if (savedPlaylists[nameKey]) {
            ...
            showDialog(getTranslation('playlistRemoved') || "Playlist retirée");
