...
function renderSidebarNav(activeProfile, currentSectionId = null) {
    ...
    navContainer.innerHTML = Object.entries(menuData).map(([key, item]) => `
        <a href="#${item.link}" 
...
function renderHeroAccordion() {
    ...
    container.innerHTML = `
        ...
        <div id="panel-2" class="accordion-panel" onclick="handleHeroClick(event, 'panel-2')">
            ...
            <div class="panel-content">
                <h1 class="hero-title">Super Mmg Bros (Desert)</h1>
    ...
    container.innerHTML = `
        <div class="music-details-grid">
            <div class="music-details-container">
                <div class="music-art-panel" style="height: auto; max-height: none;">
                    <div class="album-art-wrapper">
                        <img src="${upcomingData.image}" alt="${upcomingData.title}" class="news-main-img">
                    </div>
                </div>
                <div class="music-info-panel">
                    ...
                    <div class="details-meta-container">
                        <span class="tag-link" style="color: var(--active-color); font-weight: 800;">
...
function renderRecommendedPlaylists() {
    ...
    const recommendedPlaylists = [
        { id: 'chill', name: getTranslation('playlistChillName'), cssClass: 'reco-playlist-chill', subtitle: getTranslation('playlistChillSubtitle'), icon: 'fa-sun' },
        { id: 'frutiger', name: getTranslation('playlistFrutigerName'), cssClass: 'reco-playlist-frutiger', subtitle: getTranslation('playlistFrutigerSubtitle'), icon: 'fa-microchip' }
    ];
