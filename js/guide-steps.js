    ...
    navigation: [
        {
            ...
            content: {
                fr: "Ce guide présente les éléments de l'interface Mmg Studio. Passez instantanément de MMG MUSIC à MMG BEATS en cliquant sur l'avatar du profil.",
                en: "This guide presents the Mmg Studio interface elements. Switch instantly from MMG MUSIC to MMG BEATS by clicking the profile avatar."
            },
            position: 'right',
            onEnter: () => {
