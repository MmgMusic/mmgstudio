...
function updateAchievementProgress(id, value) {
    ...
    } else if (id === 'psPlayer' || id === 'spotimonFan') {
...
function claimDailyBonus() {
    ...
    if (loginStreak < 7) {
        ...
        const key = rewardCoins === 1 ? 'dailyBonus_one' : 'dailyBonus_many';
        rewardMessage = getTranslation(key, { count: rewardCoins, streak: loginStreak });
