...
function updateThemeColorMeta() {
    ...
    let themeColor = isDark ? '#121212' : '#ffffff';
    let navColor = isDark ? '#121212' : '#f5f5f5'; /* Ex: Whitesmoke pour le light mode */
    ...
    if (document.body.classList.contains('theme-playstation')) {
        ...
        themeColor = '#252a30'; /* Correspond au header sombre du studio */
        ...
        themeColor = '#ffffff'; /* Haut du dégradé Aero (blanc) */
        navColor = '#ffffff';
