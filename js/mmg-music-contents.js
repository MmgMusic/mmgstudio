...
function updateThemeColorMeta(forceIntro = false) {
    ...
    if (isIntroVisible) {
        ...
        if (document.body.classList.contains('theme-playstation')) {
            ...
            // Thème Default
            themeColor = '#f8f8f8'; // Légèrement off-white pour éviter le clash visuel
            navColor = '#f8f8f8';
        }
    }
