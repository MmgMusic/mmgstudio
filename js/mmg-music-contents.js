...
function renderNewsDetailsPage(newsId) {
    ...
    // STYLE CORRIGÉ: Structure simplifiée comme demandé (Image, Titre, Date, Texte)
    // Utilise le style des détails de titre pour la cohérence
    ...
    container.innerHTML = `
        <div class="track-details-container" style="padding: 20px; max-width: 800px; margin: 0 auto;">
            <div class="track-details-header" style="text-align: center; margin-bottom: 24px;">
                <img src="${news.image}" alt="${news.title}" style="width: 100%; max-width: 400px; border-radius: 16px; box-shadow: 0 10px 30px rgba(0,0,0,0.2); margin-bottom: 12px;">
                <p style="color: var(--primary-color); font-weight: 600; font-size: 0.9rem; margin-bottom: 8px;"><i class="far fa-calendar-alt"></i> ${news.date}</p>
            </div>
            <div class="track-details-info" style="line-height: 1.6; font-size: 1rem; color: var(--text-main opacity: 0.9); text-align: justify;">
                <p>${news.content}</p>
            </div>
        </div>
    `;
...
function renderUpcomingReleasePage() {
    ...
    container.innerHTML = `
        <div class="track-details-container" style="padding: 20px; max-width: 800px; margin: 0 auto;">
            <div class="track-details-header" style="text-align: center; margin-bottom: 24px;">
                <img src="${upcomingData.image}" alt="${upcomingData.title}" style="width: 100%; max-width: 400px; border-radius: 16px; box-shadow: 0 10px 30px rgba(0,0,0,0.2); margin-bottom: 12px;">
                <h2 style="font-size: 1.5rem; font-weight: 800; margin-bottom: 5px; color: var(--text-color);">${upcomingData.title}</h2>
                <p style="color: var(--active-color); font-weight: 600; font-size: 0.9rem; margin-bottom: 8px;"><i class="far fa-calendar-alt"></i> ${upcomingData.date}</p>
            </div>
            <div class="track-details-info" style="line-height: 1.6; font-size: 1rem; color: var(--text-color); opacity: 0.9; text-align: justify;">
    ...
    container.innerHTML = `
        ...
        <div id="panel-1" class="accordion-panel active" onclick="toggleAccordion('panel-1')">
            ...
            <div class="panel-content">
                ...
                <button class="hero-button dashboard-card-button" data-youtube-id="${latestItem.youtube_id}" data-item-id="${latestItem.id}" style="background: white; color: black; border: none; padding: 6px 14px; border-radius: 20px; font-weight: bold; font-size: 0.6rem;">${getTranslation('listenNow')}</button>
            </div>
        </div>
