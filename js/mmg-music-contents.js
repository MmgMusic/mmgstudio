...
function updateThemeColorMeta(forceIntro = false) {
    ...
    if (isIntroVisible) {
        ...
        if (document.body.classList.contains('theme-playstation')) {
            themeColor = '#0058b1'; // Top Bar PS3 (Bleu haut)
            ...
            themeColor = '#ffffff'; // Top Bar Blanche demandée
            navColor = '#f8fafc';   // Couleur de fond Spotimon
        } else if (document.body.classList.contains('theme-16bit')) {
            themeColor = '#f5fafd'; // Frutiger Aero Translucide (Haut)
            navColor = '#f5fafd';   // Frutiger Aero (Bas)
