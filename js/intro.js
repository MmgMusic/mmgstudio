...
document.addEventListener('DOMContentLoaded', () => {
    const el = {
        ...
        enter: document.getElementById('enter-ui'),
    ...
    function triggerExplosion() {
        ...
        setTimeout(() => {
            el.enter.classList.remove('opacity-0');
    ...
    function startApp() {
        ...
        if (el.bgMusic) {
            el.bgMusic.play().catch(e => console.warn("Playback prevented by browser until interaction."));
        }
    ...
    // On attache l'événement de clic au conteneur principal
    el.container.addEventListener('click', startApp);
